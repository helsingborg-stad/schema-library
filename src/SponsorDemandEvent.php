...
use \Municipio\Schema\Contracts\SponsorDemandEventContract;
use \Municipio\Schema\Contracts\EventContract;
use \Municipio\Schema\Contracts\ThingContract;

/**
 * Event that offers sponsorship
 *
 * @see municipio:SponsorDemandEvent
 *
 */
class SponsorDemandEvent extends BaseType implements SponsorDemandEventContract, EventContract, ThingContract
{
    /**
