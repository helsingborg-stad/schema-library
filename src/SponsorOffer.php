...
use \Municipio\Schema\Contracts\SponsorOfferContract;
...
/**
 * Organization that offers sponsorship
 *
 * @see municipio:SponsorOffer
 *
 */
class SponsorOffer extends BaseType implements SponsorOfferContract, IntangibleContract, OfferContract, ThingContract
{
    /**
